...
public class AdvGrid<T,W,C> extends Grid<T,W> {
   ...
   * 
   * @see containers.AdvGrid#AdvancedGrid(int, int)
   * @see containers.AdvGrid#fill(Object, Object, Object)
   */
   ...
   * 
   * @see containers.AdvGrid#setCorner(int, int, Direction, Direction, Object)
   */
   ...
   * 
   * @see containers.AdvGrid#setCorners(int, int, Object, Object, Object, Object)
   */
   ...
   * 
   * @see containers.AdvGrid#setWallFromCorner(int, int, Direction, Object)
   */
   ...
   * 
   * @see containers.AdvGrid#setWallsFromCorner(int, int, Object, Object, Object, Object)
   */
   ...
   * 
   * @see containers.AdvGrid#setWalls(int, int, Object)
   * @see containers.AdvGrid#setCorners(int, int, Object)
   */
   ...
   * @param lowerRight  lower right corner value
   * 
   * @see containers.AdvGrid#setWalls(int, int, Object, Object, Object, Object)
   * @see containers.AdvGrid#setCorners(int, int, Object, Object, Object, Object)
   */
   ...
   * @param lowerRight  lower right corner value
   * 
   * @see containers.AdvGrid#setWallsAndCorners(int, int, Object, Object, Object, Object, Object, Object, Object, Object)
   * @see containers.AdvGrid#set(int, int, Object)
   */
   ...
   * @param corners corner-type array containing the four corner values
   * 
   * @see containers.AdvGrid#setWallsAndCorners(int, int, Object[], Object[])
   * @see containers.AdvGrid#set(int, int, Object)
   */
   ...
   * 
   * @see containers.AdvGrid#setBorderCorners(Object)
   */
