...
public class TriGrid<T,W> {
   ...
   * 
   * @see containers.TriGrid#TriGrid(int)
   * @see containers.TriGrid#fill(Object, Object)
   */
   ...
   * @throws IndexOutOfBoundsException if the coordinates are not valid
   * 
   * @see containers.TriGrid#setWall(int, int, Slot, Direction, Object)
   */
   ...
   * @throws IndexOutOfBoundsException if the coordinates are not valid
   * 
   * @see containers.TriGrid#setWall(TriPoint, Direction, Object)
   */
   ...
   * @throws IndexOutOfBoundsException if the coordinates are not valid
   * 
   * @see containers.TriGrid#setWalls(int, int, Slot, Object, Object, Object)
   */
   ...
   * @throws IndexOutOfBoundsException if the coordinates are not valid
   * 
   * @see containers.TriGrid#setWalls(int, int, Slot, Object)
   */
   ...
   * @param defaultWall value all walls will be set to
   * 
   * @see containers.TriGrid#set(int, int, Slot, Object)
   * @see containers.TriGrid#setWalls(int, int, Slot, Object)
   */
   ...
   * @return          Direction the second slot is in relative to the first slot
   * 
   * @see containers.TriGrid#calcDirection(int, int, Slot, int, int, Slot)
   */
   ...
   * @return      true if the coordinates are valid, false if they're not
   * 
   * @see containers.TriGrid#areCordsValid(int, int, Slot)
   */
   ...
   * 
   * @see containers.Grid#convert(java.awt.Point)
   */
   ...
   * 
   * @see containers.TriGrid#get(int, int, Slot)
   */
