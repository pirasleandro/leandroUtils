...
public class Grid<T, W> {
   ...
   * 
   * @see containers.Grid#Grid(int, int)
   * @see containers.Grid#fill(Object, Object)
   */
   ...
   * @param value value that the cell will be set to
   * 
   * @see containers.Grid#set(int, int, Object)
   */
   ...
   * 
   * @see containers.Grid#setWall(int, int, Direction, Object)
   */
   ...
   * 
   * @see containers.Grid#setWalls(int, int, Object, Object, Object, Object)
   * 
   ...
   * 
   * @see containers.Grid#calcDirection(int, int, int, int)
   */
   ...
   * 
   * @see containers.Grid#convert(int)
   */
   ...
   * @return      point with converted coordinates
   * 
   * @see containers.Grid#convert(Point)
   * @see containers.Grid#convertBack(int)
   */
   ...
   * @return      value of the cell
   * 
   * @see containers.Grid#get(int, int)
   */
   ...
   * @return
   * 
   * @see containers.Grid#areCordsValid(int, int)
   */
