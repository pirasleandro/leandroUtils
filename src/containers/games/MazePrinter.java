...
public class MazePrinter {
  ...
  String[] complexFormat = {
      ...
      Box.d + " ", Box.r_d + Box.h, Box.l_d + " ", Box.hd + Box.h,
      Box.u + " ", Box.r_u + Box.h, Box.l_u + " ", Box.uh + Box.h,
   ...
   * 
   * @see containers.games.MazePrinter#validateFormat(String, String, String, String[])
   * @see containers.games.MazePrinter#formatCorner(int, int, String[])
   * @see containers.games.MazePrinter#formatWallFromCorner(int, int, Direction, String[])
   * @see containers.games.MazePrinter#formatWall(int, int, Direction, String[])
   */
   ...
   * @throws IllegalArgumentException if the format isn't valid
   * 
   * @see containers.games.MazePrinter#print(String, String, String, String[])
   * @see containers.games.MazePrinter#validateFormat(String, String, String, String[])
   * @see containers.games.MazePrinter#formatCorner(int, int, String[])
   * @see containers.games.MazePrinter#formatWallFromCorner(int, int, Direction, String[])
   * @see containers.games.MazePrinter#formatWall(int, int, Direction, String[])
   ...
   * 
   * @see containers.games.MazePrinter#validateFormat(String[])
   * 
