...
import com.github.pirasleandro.characters.*;
import com.github.pirasleandro.containers.AdvGrid;
import com.github.pirasleandro.containers.Direction;
import com.github.pirasleandro.containers.Grid;
...
public class Maze {
   ...
   * @return
   * 
   * @see com.github.pirasleandro.containers.games.Maze#toIntArray(boolean, boolean)
   */
   ...
   * @return          String of converted maze
   * 
   * @see com.github.pirasleandro.containers.games.Maze#toString(String, String, String, String, String)
   */
   ...
   * 
   * @see com.github.pirasleandro.containers.games.Maze#toString(String, String, String, String, String)
   * @see com.github.pirasleandro.containers.games.Maze#toString(String, String, String, String)
   */
   ...
   * @see com.github.pirasleandro.containers.games.Maze#toString(String, String, String, String, String)
   * @see com.github.pirasleandro.containers.games.Maze#toString(String, String, String, String)
   * @see com.github.pirasleandro.containers.games.Maze#toString(String, String)
   */
  public String toString() {
    return toString("  ", Block.FULL_BLOCK.repeat(2));
  }
